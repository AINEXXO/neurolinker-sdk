...
from neurolinker_sdk import AsyncNeuroLinker, ContentType
...
async def test_e2e_with_explicit_client_parameters() -> None:
    ...
    async with AsyncNeuroLinker(
        ...
        status_resp = await client.extraction.wait_for_request(
            request_uid,
            timeout_s=600.0,
            poll_interval_s=1.5,
        ...
        markdown = await client.extraction.documents.markdown(
            document_ids,
