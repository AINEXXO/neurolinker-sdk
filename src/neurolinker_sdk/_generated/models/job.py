...
class Job(BaseModel):
    ...
    Job
    """ # noqa: E501
    request_uid: StrictStr = Field(description="Unique identifier for the job")
    status: StrictStr = Field(description="Status of the job")
    performance: Optional[JobPerformance] = None
    msg: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["request_uid", "status", "performance", "msg"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "performance": JobPerformance.from_dict(obj["performance"]) if obj.get("performance") is not None else None,
            "msg": obj.get("msg")
        })
        return _obj
