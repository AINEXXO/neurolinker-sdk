...
class CreatePDFResponse(BaseModel):
    ...
    CreatePDFResponse
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the PDF creation was successful")
    filename: StrictStr = Field(description="Generated PDF filename")
    url: Optional[StrictStr] = None
    message: StrictStr = Field(description="Human-readable status message")
    __properties: ClassVar[List[str]] = ["success", "filename", "url", "message"]
