...
class DocumentsResource:
    ...
    def fields(self, document_ids: List[str]) -> Dict[str, Any]:
        """
        POST /v1/documents/fields

        Retrieves the extracted fields payload for documents processed through
        field extraction. Returns an error entry for documents processed
